...
namespace TestProject
{
    ...
    class Vision1
    {
        static void Main()
        {
            ...
            GenericsMethods<int[]> generics = new GenericsMethods<int[]>();
    ...
    class Vision2 // класс, где происходит взаимодействие строки и метода
    {
        static void Main()
        {
    ...
    class Vision3 // класс UI с самой простой защитой от дурака, которая просто заканчивает программу
    {
        static void Main()
        {
